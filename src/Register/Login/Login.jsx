...
<Button type="submit" className="w-full bg-[#461773] text-white font-bold rounded-md hover:bg-purple-700 transition h-[50px]">Login</Button>
</form> </Form>

<p className="text-m text-gray-600 mt-4 text-center">Don't have an account? <Link to="/formtry" className="text-purple-600 font-semibold hover:underline">Register</Link></p>
