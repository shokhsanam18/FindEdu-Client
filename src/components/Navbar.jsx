...
export default function Navbar() {
  ...
  const regions = [{ value: "", label: "Mintaqa →" }, { value: "tashkent", label: "Tashkent" }, { value: "samarkand", label: "Samarkand" }];
  const levels = [{ value: "", label: "Darajasi →" }, { value: "beginner", label: "Beginner" }, { value: "advanced", label: "Advanced" }];
  const studyTypes = [{ value: "", label: "O'qish turi →" }, { value: "online", label: "Online" }, { value: "offline", label: "Offline" }];
  const directions = [{ value: "", label: "Yo'nalish →" }, { value: "it", label: "IT" }, { value: "marketing", label: "Marketing" },{ value: "sat", label: "SAT" },{ value: "IELTS", label: "IELTS" }];
  const prices = [{ value: "", label: "Narxi →" }, { value: "free", label: "Free" }, { value: "paid", label: "Paid" }];
      ...
      <div className="bg-white h-16 md:h-20 p-4 pl-6 md:pl-12 flex items-center justify-between ml-4 mr-4 md:ml-6 md:mr-6 lg:ml-10 lg:mr-10 xl:ml-16 xl:mr-16">
        <div className="text-2xl md:text-4xl font-bold text-[#461773] flex items-center">
          <a href="/" className="flex items-center">
            F <span className="text-yellow-500 text-2xl md:text-4xl">i</span>ndedu.uz
          </a>
        </div>

        <div className="hidden md:flex gap-4 md:gap-8 text-gray-700 font-semibold text-lg md:text-xl">
          <a href="#" className="hover:text-[#461773]">O‘quv markazlar</a>
          <a href="#" className="hover:text-[#461773]">Loyiha haqida</a>
        </div>
  ...
  <div className="container mx-auto flex items-center rounded-full border-2 border-[#461773] mx-4 md:mx-6 lg:mx-10 xl:mx-20 px-2 md:px-4 py-1 md:py-2 text-[#000000]">
    ...
    <div className="flex items-center">
      <div className="border-l border-[#000000]">
        <Select onValueChange={handleRegionChange} value={region}>
          <SelectTrigger className="w-[80px] md:w-[120px] lg:w-[160px] border-none bg-transparent text-left rounded-none focus-visible:ring-0 pl-2 md:pl-4"
            style={{ color: '#000000' }}>
      ...
      <div className="border-l border-[#000000]">
        <Select onValueChange={handleLevelChange} value={level}>
          <SelectTrigger className="w-[80px] md:w-[100px] lg:w-[140px] border-none bg-transparent text-left rounded-none focus-visible:ring-0 pl-2 md:pl-4"
            style={{ color: '#000000' }}>
      ...
      <div className="border-l border-[#000000]">
        <Select onValueChange={handleStudyTypeChange} value={studyType}>
          <SelectTrigger className="w-[90px] md:w-[120px] lg:w-[160px] border-none bg-transparent text-left rounded-none focus-visible:ring-0 pl-2 md:pl-4"
            style={{ color: '#000000' }}>
      ...
      <div className="border-l border-r border-[#000000]">
        <Select onValueChange={handlePriceChange} value={price}>
          <SelectTrigger className="w-[60px] md:w-[80px] lg:w-[100px] border-none bg-transparent text-left rounded-none focus-visible:ring-0 pl-2 md:pl-4"
            style={{ color: '#000000' }}>
