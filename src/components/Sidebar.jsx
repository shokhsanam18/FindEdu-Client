...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 w-64 h-full p-6 bg-white shadow-lg z-50 transition-transform duration-300 transform ${isOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        role="navigation"
        aria-label="Sidebar"
      >
